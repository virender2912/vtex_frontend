    ...
    return (
        <header className="header">
            <div className="header-top">
                ...
                {/* Logo */}
                <Link to="/">
                    <div className="header-top-right logo">
                        <span className="icon icon--fill header__image-logo">
                       <svg width="75" height="27" fill="#00524d" viewBox="0 0 75 27" xmlns="http://www.w3.org/2000/svg">
